...
HELP_DICT = {
    ...
    "🎵 **Музыка и тексты:**": {
        ...
        "`.dl` / `.скачать` / `.дл` [режим] [ссылка]": "Интерактивно скачать медиа; режимы best/1080/720/480/360/audio и 0/1/2.",
        "`.dl0` / `.dlo` [ссылка]": "Скачать автоматически в качестве не выше 480p.",
        "`.cookies` / `.куки` [test платформа URL]": "Состояние и безопасная проверка cookies downloader.",
    },
    "🛠 **Инструменты:**": {
